...
__attribute_reloc__ void (*setup_tex_draw)(bool unk0, bool unk1, bool is_linear_color);
...
// helpers
__attribute_reloc__ f32 (*fast_sin)(s32);
__attribute_reloc__ f32 (*fast_cos)(s32);
